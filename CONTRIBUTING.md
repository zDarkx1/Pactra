...
Use TDD for behavior, run root JS/docs/typecheck/build and backend race/vet. Never remove a failing business assertion just to make CI green. CI does not deploy or spend money.
