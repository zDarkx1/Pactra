...
- Project: Pactra (`ncnuvnbqcaqwawujltiu`)
...
- Dedicated role: pactra_runtime, no superuser/create-role/create-db/bypass-RLS, connection limit8, statement timeout5seconds and idle-in-transaction timeout10seconds.
