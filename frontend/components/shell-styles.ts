...
export const shellStyles = {
  ...
  topbar: 'flex min-h-19 bg-(--canvas) flex-wrap items-center justify-between gap-3 border-b border-(--hairline) px-5 py-3.5 md:min-h-[81px] md:flex-nowrap md:gap-4 md:px-6 md:py-4 lg:px-8 max-[380px]:px-4',
