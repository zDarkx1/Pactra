...
function TaskDetail({ id }: { id: string }) {
  ...
  return <div className={styles.stack}>
    ...
    {loading && !task ? <TaskLoading label="Loading agreement…" /> : visibleTask ? <>
      ...
      <ManifestDetails terms={visibleTask.manifest} manifest={visibleTask.manifest} manifestHash={visibleTask.manifest_hash} buyer={visibleTask.manifest.buyer} chainId={visibleTask.manifest.chain_id} total={visibleTask.manifest.total_base_units} />
